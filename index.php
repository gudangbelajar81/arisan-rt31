...
<body>
    <div class="container">
        ...
        <div class="menu-box">
            ...
            <a href="pertemuan.php" class="btn" style="background: rgba(255,255,255,0.7); border: 2px solid #cca300; color: #cca300; display: block; text-align: center; backdrop-filter: blur(5px);">📅 Jadwal Pertemuan Rutin</a>
